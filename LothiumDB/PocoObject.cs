    ...
    internal sealed class PocoObject<T>
    {
        ...
        private void InitializeObject(object? obj = null)
        {
            try
            {
                ...
                var tbAttrData = Attribute.GetCustomAttribute(pocoObjType, typeof(TableNameAttribute)) as TableNameAttribute;
                ...
                foreach (var p in pInfo)
                {
                    ...
                    var colNameAttrData = Attribute.GetCustomAttribute(p, typeof(ColumnNameAttribute)) as ColumnNameAttribute;
                    var colRequiredAttrData = Attribute.GetCustomAttribute(p, typeof(RequiredColumnAttribute)) as RequiredColumnAttribute;
                    var colPrimaryKeyAttrData = Attribute.GetCustomAttribute(p, typeof(PrimaryKeyAttribute)) as PrimaryKeyAttribute;
                    var colExcludedColAttrData = Attribute.GetCustomAttribute(p, typeof(ExcludeColumnAttribute)) as ExcludeColumnAttribute;
                    ...
                    ColumnDataInfo.Add(new PocoColumnsData(
                        ...
                        colPrimaryKeyAttrData == null ? null : new PocoPrimaryKeyData(p.GetType(), colPrimaryKeyAttrData.IsAutoIncremenetKey)));
                }
            }
            catch (Exception ex)
            {
